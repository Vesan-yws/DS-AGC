...
class SemiGCL(nn.Module):
    def __init__(self, net_params):
        ...
        self.domain_classifier2 = adversarial.DomainAdversarialLoss(hidden_1=64)
        self.domain_classifier3 = adversarial.TripleDomainAdversarialLoss(hidden_1=64)
        self.domain_classifier2_3 = adversarial.DomainAdversarialLoss_threeada(hidden_1=64)
